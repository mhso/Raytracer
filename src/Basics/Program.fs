...
let main _ = 
    ...
    let sL = SphereShape(Point(-3., 0., -3.), 1., matteRed)
    let sC = SphereShape(Point(0., 0., -2.), 1., matteYellow)
    let sR = SphereShape(Point(3., 0., -1.), 1., matteGreen)
    ...
    let camera          = ThinLensCamera(position, lookat, up, zoom, width, height, resX, resY, 1.0, 6.0,
