...
let allTest =
  ...
  let test01 =
      let p = polyToUnipoly (polyAsList ((parseStr >> exprToPoly) "3x^3 + 3x^2 + 5x + 1" "x")) 1. 1. 1. 1. 1. 1.
  ...
  let test03 =
    let up = polyToUnipoly (polyAsList ((parseStr >> exprToPoly) "x^4 + 2x^2 + 4x + 1" "x")) 1. 1. 1. 1. 1. 1.
